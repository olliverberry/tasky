      ...
      template: {
        ...
        spec: {
          ...
          containers: [
            {
              name: "server",
              image: `${config.k8s.dockerRegistry}/${config.k8s.imageName}:${config.k8s.imageTag}`,
...
export const serverServiceHostName =
  serverService.status.loadBalancer.ingress[0].hostname;
